...
public class Main extends Application{
    ...
    public void start(Stage stage) throws Exception{
        ...
        clickHandle.setOnMouseClicked(event ->{
            ...
            if (!selectedPieceCoordinates.isEmpty() && piecesOnBoard[selectedPieceCoordinates.get(0)][selectedPieceCoordinates.get(1)].possibleMoves().contains(selectedSquare)){
                movingPieces(piecesOnBoard, selectedSquare, selectedPieceCoordinates, clickHandle);
                //whiteKing.cureCheck();
                //blackKing.cureCheck();
            }
            ...
            if (piecesOnBoard[x][y] != null && piecesOnBoard[x][y].getColour() == turn){
                selectPieceToMoveItLater(selectedPieceCoordinates, circles, clickHandle, x, y);
                //System.out.println(piecesOnBoard[x][y].possibleMoves());
                //whiteKing.cureCheck();
                //blackKing.cureCheck();
            }

            //if (turn == Turn.WHITE){
            //    possiblePlacementView(clickHandle, whiteKing.getPositionsOverWhichTheKingCanBeAttacked(), circles);
            //}
            //else{
            //    possiblePlacementView(clickHandle, blackKing.getPositionsOverWhichTheKingCanBeAttacked(), circles);
            //}
    ...
    public void selectPieceToMoveItLater(List <Integer> selectedPieceCoordinates, List <Circle> circles, Pane clickHandle, int row, int column){
    ...
    public void movingPieces(Piece[][] piecesOnBoard,  List<Integer> selectedSquare, List<Integer> selectedPieceCoordinates, Pane clickHandle){
        ...
        //Add the picture to the new space
        ...
        //Need to add a function seeing if the king is in check.
        //if (turn == Turn.WHITE){
        //    whiteKing.kingAttackPositions();
        //}
        //else{
        //    blackKing.kingAttackPositions();
        //}
    }
    ...
    public static void main(String[] args) {
        ...
        String k = "AB";
        char u = 'B';
        System.out.println(k.charAt(1) == u);
    }
}
